...
///<sumary> 
///Classe que define o funcionamento dos "SpawnPoints"
///</sumary>
public class PontoSpawn : MonoBehaviour
{
    ...
    int spawnedEnemyCount;          // Quantidade de inimigos spawnados até agora (em todos os rounds)
    ...
    */
    ...
    void Update()
    {
        ...
        { // Se todos os inimigos foram mortos
            spawnRate++;
            SpawnaInimigos();
